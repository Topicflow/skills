...
The entry points and durable context the focused skills lean on.

- **[save-private-note](./save-private-note/SKILL.md)** — the memory habit. People say the most
  useful things in passing ("she hates public praise", "he's never run a migration"); this
  catches them and restates them in one third-person sentence. Every other skill hands its durable
  findings here (library convention 3). On a deployment without the private-note tools, it hands
