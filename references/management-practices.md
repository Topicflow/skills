# Management Practices — shared reference for all skills
...
| request-feedback | P5 (question design) P10 (blind spots) | good coach; collaborates |
| give-recognition | P8 P9 P10 | cares about success and well-being |
| recognition-scan | P8 P10 | cares about success and well-being |
| goal-checkin | P11 P12 P15 | productive and results-oriented |
| relationship-drift | P2 P10 P13 (career-talk recency) | cares about success and well-being |
| weekly-brief | P3 (signal, not status theater) | productive and results-oriented |
| stuck-work | P15 P16 | empowers, does not micromanage |
| onboard-direct-report | P13 P16 (first conversations, maturity baseline) | supports career development |
| review-prep | P5 (evidence in SBI form) P10 (equity across reports) | strong decision maker; communicates well |
| save-context | P9 P16 (preferences and maturity are memory-worthy facts) | cares about success and well-being |
| management-practices | all — it is the checklist | — |
